         ...
         >
            <Stack w={isMobile ? "100%" : "30%"} align='center'>
               ...
               <Stack direction='row' w='100%'>
                  <FaHandPointRight color='#8A7DD8' />
                  <Text fontSize='xs' w='95%'>
                     Una vez publicado será visible para todos y te podrán
                     contactar vía Whatsapp para comprarlo/recibirlo.
                  </Text>
               </Stack>
            </Stack>
            <Stack w={isMobile ? "100%" : "30%"} align='center'>
               ...
               <Stack direction='row' w='100%'>
                  <FaHandPointRight color='#8A7DD8' />
                  <Text fontSize='xs' w='95%'>
                     No es necesario que te registres ni que brindes datos sobre
                     vos.
                  </Text>
               </Stack>
               <Stack direction='row' w='100%'>
                  <FaHandPointRight color='#8A7DD8' />
                  <Text fontSize='xs' w='95%'>
                     Podés navegar en el home e ir filtrando por categorías
                     hasta encontrar algo que te guste.
                  </Text>
               </Stack>
               <Stack direction='row' w='100%'>
                  <FaHandPointRight color='#8A7DD8' />
                  <Text fontSize='xs' w='95%'>
                     Una vez que encontraste algo, vas a poder contactar vía
                     whatsapp al propietario para coordinar la entrega.
                  </Text>
               </Stack>
            </Stack>
            <Stack w={isMobile ? "100%" : "30%"} align='center'>
               ...
               <Stack direction='row' w='100%'>
                  <FaHandPointRight color='#8A7DD8' />
                  <Text fontSize='xs' w='95%'>
                     Una vez logeado, en la sección "Perfil" vas a poder
                     modificar tus datos.
                  </Text>
               </Stack>
               <Stack direction='row' w='100%'>
