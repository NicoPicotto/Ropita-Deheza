			...
			>
				...
				<Stack spacing={2}>
					...
					<Text>
						...
						sitios web de otras empresas que figuran en la lista; <br /> y
					...
					<Text>
						...
						benéficas;
						<br /> distribuidores de directorios en línea; portales de Internet;{' '}
						<br />
					...
					<Text>
						...
						enviando un correo electrónico a No Cuelgues. Incluye tu nombre, el
					...
					<Text>
						...
						<br /> o Mediante el uso del localizador uniforme de recursos al que
						se está vinculando;
						<br /> o Usar cualquier otra descripción de nuestro sitio web al que
						está vinculado que tenga sentido dentro del contexto y formato del
						contenido en el sitio de la parte vinculante. <br />
						No se permitirá el uso del logotipo de No Cuelgues u otro material
					...
					<Text>
						...
						no estamos obligados a hacerlo ni a responder directamente. No nos
						aseguramos de que la información de este sitio web sea correcta. No
						garantizamos su integridad o precisión, ni prometemos asegurarnos de
						que el sitio web permanezca disponible o que el material en el sitio
					...
					<Text>
						...
						lesiones personales; <br /> limitará o excluirá nuestra
						...
						cualquier manera que no esté permitida por la ley aplicable; <br />o
